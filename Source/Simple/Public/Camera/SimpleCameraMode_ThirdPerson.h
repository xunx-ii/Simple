...
#include "SimpleCameraMode.h"
#include "Curves/CurveFloat.h"
#include "SimplePenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "SimpleCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * USimpleCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class USimpleCameraMode_ThirdPerson : public USimpleCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FSimplePenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
