...
#include "SimplePrimaryLayout.generated.h"
...
UCLASS()
class SIMPLE_API USimplePrimaryLayout : public UCommonUserWidget
{
	GENERATED_BODY()
public:
	USimplePrimaryLayout(const FObjectInitializer& ObjectInitializer);

public:
	template <typename ActivatableWidgetT = UCommonActivatableWidget>
	TSharedPtr<FStreamableHandle> PushWidgetToLayerStackAsync(FGameplayTag LayerName, TSoftClassPtr<UCommonActivatableWidget> ActivatableWidgetClass)
	{
	...
	template <typename ActivatableWidgetT = UCommonActivatableWidget>
	TSharedPtr<FStreamableHandle> PushWidgetToLayerStackAsync(FGameplayTag LayerName, TSoftClassPtr<UCommonActivatableWidget> ActivatableWidgetClass, TFunction<void(EAsyncWidgetLayerState, ActivatableWidgetT*)> StateFunc)
	{
